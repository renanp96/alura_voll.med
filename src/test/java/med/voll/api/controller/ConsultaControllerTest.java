...
class ConsultaControllerTest {
    ...
    @Test
    @DisplayName("Retornar erro 400 ao receber dados invalidos.")
    @WithMockUser
    ...
    @Test
    @WithMockUser
    @DisplayName("Retorna codigo 200 quando os dados estiverem validas")
    void agendar_cenario2() throws Exception {
        ...
        MockHttpServletResponse response = mvc.perform(
                post("/consultas").contentType(MediaType.APPLICATION_JSON).content(dadosAgendamentoConsultaJson.write(
        ...
        String jsonResponse = dadosDetalhamentoConsultaJson.write(
